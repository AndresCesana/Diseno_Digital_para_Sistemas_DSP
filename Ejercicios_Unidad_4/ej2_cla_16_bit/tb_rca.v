...
module tb_rca #(
    ...
    initial begin
        ...
        $display("CSV,RCA,%0d,%0d,%0d,%0d,%0d,%0d",
            N, 5*N, t_delay_cin, t_delay_data, n_pass, n_fail);
    end
...
module tb_top;
    ...
    tb_rca #(.N(4),  .START_TIME(0*SLOT)) tb04 ();
    tb_rca #(.N(8),  .START_TIME(1*SLOT)) tb08 ();
    tb_rca #(.N(16), .START_TIME(2*SLOT)) tb16 ();
    tb_rca #(.N(32), .START_TIME(3*SLOT)) tb32 ();
